/*
 * File Overview:
 * Use Case: Static constants, labels, plans, style maps, categories aur UI configuration hold karta hai.
 * Project Role: Magic strings hata kar app-wide consistency maintain karta hai.
 * Typical Trigger: Multiple UI/components isse import karke display/logic constants use karte hain.
 * File Path: lib/data.js
 */
import { GoldTitle, GrayTitle } from "@/components/reusables";

// Note: landing page/social proof logos.
export const LOGOS = [
...
// Note: hero section stacked user avatars.
...
// Note: feature card me dikhne wale sample AI tags.
...
// Note: landing UI ke mock availability chips.
export const SLOTS = [
  {
    label: "Mon 10:00 AM",
...
// Note: subscription plans + Clerk plan IDs mapping.
export const PLANS = [
  {
    name: "Free",
    price: "$0",
...
// Note: onboarding/marketing role messaging blocks.
export const ROLES = [
  {
    label: "Interviewee",
...
// Note: explore filter categories list.
...
// Note: enum value -> user-friendly label map.
...
// onboarding
// Note: interviewer years of experience options.
...
// Note: onboarding role selection cards content.
...
// Note: booking status ke badge styles.
...
// Note: feedback overall rating styles.
...
// Note: rating enum -> readable text label.
...
// Feedback Modal
// Note: feedback modal ke section-wise visual presets.
...
// Booking Page
// Note: booking detail page ke "what to expect" bullets.
