/*
 * File Overview:
 * Use Case: Explore page shell aur interviewer grid mount karta hai.
 * Project Role: Candidate discovery flow ka root page hai.
 * Trigger: Explore route open hone par.
 * File Path: app/(main)/explore/page.jsx
 */
