...
/*
 * File Overview:
 * Use Case: Search + category filters ke saath interviewer list filter/render karta hai.
 * Project Role: Discovery UX me interactive filtering layer provide karta hai.
 * Trigger: Explore page render + user filter input ke time.
 * File Path: app/(main)/explore/components/ExploreGrid.jsx
 */
...
export default function ExploreGrid({ interviewers }) {
  ...
  const filtered = useMemo(() => {
    //usememo basically caches the result of the function and only recomputes it when the dependencies change. In this case, it will only recompute the filtered interviewers when the interviewers, activeCategory, or search state changes. This can help improve performance by avoiding unnecessary computations on every render.
