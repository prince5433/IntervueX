/*
 * File Overview:
 * Use Case: Interviewer detail profile + booking context data render karta hai.
 * Project Role: Booking decision page ka primary detail screen hai.
 * Trigger: Specific interviewer profile open hone par.
 * File Path: app/(main)/interviewers/[id]/page.jsx
 */
        ...
        <div className="lg:col-span-3 flex flex-col gap-6 order-2 lg:-order-1">
          ...
          <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
            <div>
              ...
              <p className="text-sm text-stone-500 font-light mt-1">
                Every session on IntervueX includes the following.
              </p>
            </div>
