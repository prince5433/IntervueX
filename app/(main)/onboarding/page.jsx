...
/*
 * File Overview:
 * Use Case: Role selection aur interviewer details form handle karta hai.
 * Project Role: User ki role identity aur profile completeness decide karta hai.
 * Trigger: UNASSIGNED user onboarding flow me.
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-5xl leading-tight tracking-tighter mt-1">
            ...
            <br />
            <GoldTitle>using IntervueX?</GoldTitle>
          </h1>
