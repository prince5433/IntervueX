/*
 * File Overview:
 * Use Case: Interviewer dashboard tabs ke liye required server data parallel load karta hai.
 * Project Role: Interviewer operations view ka root orchestrator hai.
 * Trigger: Dashboard route hit hone par.
...
export default async function InterviewerDashboardPage() {
  ...
  // Note: independent data fetches parallel me chal rahe hain,
  // isse dashboard TTFB kaafi better hota hai.
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <PageHeader
        ...
        description={
          // Note: profile incomplete ho to UI break na kare,
          // isliye description optional fallback ke saath render hota hai.
