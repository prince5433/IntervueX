...
/*
 * File Overview:
 * Use Case: Interviewer side appointments listing cards render karta hai.
 * Project Role: Session visibility aur status tracking ko structured view deta hai.
 * Trigger: Dashboard appointments tab active hone par.
 * File Path: app/(main)/dashboard/components/AppointmentsSection.jsx
 */
