...
/*
 * File Overview:
 * Use Case: Shared appointment card with context actions (join/recording/feedback).
 * Project Role: Role-specific appointment UX ko unify karta hai.
 * Trigger: Appointments/dashboard sections me booking list render hote waqt.
 * File Path: components/AppointmentCard.jsx
 */
          ...
          <div className="flex items-center gap-2 flex-wrap pt-1">
            ...
            {showRecordingPlaceholder && (
              <Button
                ...
                title={
                  isUpcoming
                    ? "Recording will appear after the call ends and processing completes."
                    : "Recording is processing. Please check again shortly."
                }
              >
                📹 Recording
              </Button>
