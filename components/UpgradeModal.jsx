...
/*
 * File Overview:
 * Use Case: Plan upgrade modal shell with pricing content show karta hai.
 * Project Role: Insufficient credits / upsell scenarios me conversion prompt deta hai.
 * Trigger: Credit-gated actions par modal open hone par.
 * File Path: components/UpgradeModal.jsx
 */
import {
  Dialog,
  DialogContent,
