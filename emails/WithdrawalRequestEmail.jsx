/*
 * File Overview:
 * Use Case: Withdrawal request admin email template render karta hai.
 * Project Role: Financial ops notification channel ka template source hai.
 * Trigger: Withdrawal request create hone par email render/send flow me.
 * File Path: emails/WithdrawalRequestEmail.jsx
 */
import {
  Html,
  Body,
